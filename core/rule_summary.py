...
def _omission_metrics(role_details: dict) -> list:
...
def _contacts_long_metrics(role_details: dict) -> list:
...
def _contacts_short_metrics(role_details: dict) -> list:
...
def _top_contacts_metrics(role_details: dict) -> list:
...
def _top_platform_metrics(role_details: dict) -> list:
...
def _platform_contacts_overlap_metrics(role_details: dict) -> list:
...
def _window_geometry_metrics(role_details: dict) -> list:
...
def _window_sinks_metrics(role_details: dict) -> list:
...
def _sinks_metrics(role_details: dict) -> list:
...
def _glass_metrics(role_details: dict) -> list:
...
def _glass_on_contacts_metrics(role_details: dict) -> list:
    ...
    if isinstance(hits, int):
        metrics.add(_metric("Стекла, шт", hits, unit="", key="glass_count"))
...
# Реестр сборщиков метрик по имени правила: {rule_name: builder}.
_ROLE_METRIC_BUILDERS = {
    "long_omission": _omission_metrics,
    "short_omission": _omission_metrics,
    "contacts_long": _contacts_long_metrics,
    "contacts_short": _contacts_short_metrics,
    "top_contacts": _top_contacts_metrics,
    "top_platform": _top_platform_metrics,
    "platform_contacts_overlap": _platform_contacts_overlap_metrics,
    "window_geometry": _window_geometry_metrics,
    "window_sinks": _window_sinks_metrics,
    "sinks": _sinks_metrics,
    "glass": _glass_metrics,
    "glass_on_contacts": _glass_on_contacts_metrics,
}


def _role_metrics(rule_name: str, role_details: dict) -> list:
    builder = _ROLE_METRIC_BUILDERS.get(rule_name)
