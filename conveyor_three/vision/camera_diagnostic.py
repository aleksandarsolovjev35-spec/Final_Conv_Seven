...
Фаза 2 — воспроизведение основного запуска: три роли из
...
Код выхода: 0 — найдено не менее 3 исправных ID и (если mapping задан)
все 3 роли открылись; 1 — любая проблема.
"""
