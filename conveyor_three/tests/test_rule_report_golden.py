...
GOLDEN_SHA256 = "07f9edd4f1c58008e3f1202ec6c3f2f41d06f7875befe02ad4becfb587c29055"
...
CASES = [
    ...
    res("part_presence", False, {
        "empty_tray": False,
        "windows_by_role": {"RIGHT": 4, "LEFT": 3},
        "min_windows_by_role": {"RIGHT": 1, "LEFT": 1},
        "presence_by_role": {"RIGHT": True, "LEFT": True},
    }),
    res("part_presence", False, {
        "empty_tray": True,
        "windows_by_role": {"RIGHT": 0, "LEFT": 0},
        "min_windows_by_role": {"RIGHT": 1, "LEFT": 1},
        "presence_by_role": {"RIGHT": False, "LEFT": False},
    }),
    # --- uneven_heights ---
    res("uneven_heights", False, {"per_role": role(
        "RIGHT", triggered=False, reason=None, found=4, measured=4,
    ...
    res("uneven_heights", True, {"per_role": role(
        "LEFT", triggered=True, reason="height_above_max",
    ...
    res("uneven_heights", True, {"per_role": role(
        "LEFT", triggered=True, reason="spread_exceeded",
    ...
    res("window_sinks", True, {"per_role": role(
        "RIGHT", triggered=True, reason="sinks_found", found=2,
        min_confidence=0.8,
    )}),
    res("window_sinks", False, {"per_role": role(
        "LEFT", triggered=False, reason=None, found=0, min_confidence=0.8,
    )}),
    ...
    res("uneven_heights", True, {
        ...
        "role_status": [
            {"role": "RIGHT", "status": "ОТКЛОНЕНИЕ", "reason": None},
        ],
    }),
]
...
def render_corpus() -> str:
    ...
    for case in CASES:
        scoped = scope_rule_result_to_role(case, "RIGHT")
